...
export function CustomerFooter() {
  return (
    <footer className="border-t border-white/10 bg-[var(--green-house)] text-white">
      <div className="container-page grid gap-8 py-12 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          <div className="flex items-center gap-2 text-lg font-semibold">
            <Image src="/logo.png" alt="Summit Gear Logo" width={32} height={32} className="rounded-full bg-white p-1" />
            Summit Gear
          </div>
