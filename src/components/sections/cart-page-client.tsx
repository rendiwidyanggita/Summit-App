...
export function CartPageClient() {
        ...
        <Card>
          <CardContent className="grid min-h-96 place-items-center p-8 text-center">
            <div>
              ...
              <h1 className="mt-5 text-2xl font-semibold tracking-normal">Keranjang kosong</h1>
              <p className="mt-2 max-w-md text-sm text-muted-foreground">Item berhasil dihapus. Jelajahi katalog Sprint 3 untuk memilih gear pendakian baru.</p>
  ...
  return (
    <div className="container-page py-8">
      <section className="mb-6 overflow-hidden rounded-[1.25rem] border bg-primary text-primary-foreground shadow-sm">
      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        <div className="grid gap-4">
          ...
          <div className="grid gap-3 rounded-lg border bg-[linear-gradient(135deg,var(--secondary),var(--background))] p-4 text-sm sm:grid-cols-3">
            {[
